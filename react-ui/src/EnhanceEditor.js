...
setImage = () => {
  ...
  axios.post('http://localhost:5000/api/process/change_image', myob)
  .then(res => {
...
confirm = () => {
  ...
  axios.post('http://localhost:5000/api/process/confirm', myob2)
 .then(res => {
   console.log(res.data)
 })
 .catch(function (error) {
...
afterSelector = (nu) => {
  ...
  if (nu === 0){
    ...
    axios.post('http://localhost:5000/api/process/blur', myob2)
 	 .then(res => {
     var myAr = []
     myAr.push(res.data)
  ...
  console.log(error);
    ...
    var myob2 = {}
    myob2['email'] = this.state.beforeIM.email
    axios.post('http://localhost:5000/api/process/hist_eq', myob2)
 	 .then(res => {
  ...
  console.log(error);
    ...
    var myob2 = {}
    myob2['email'] = this.state.beforeIM.email
    axios.post('http://localhost:5000/api/process/contrast_stretch', myob2)
 	 .then(res => {
     var myAr = []
     myAr.push(res.data)
     this.setState({afterIM: myAr}, () => {
  ...
  console.log(error);
    ...
    var myob2 = {}
    myob2['email'] = this.state.beforeIM.email
    axios.post('http://localhost:5000/api/process/log_compression', myob2)
 	 .then(res => {
     var myAr = []
     myAr.push(res.data)
     this.setState({afterIM: myAr}, () => {
  ...
  console.log(error);
    ...
    var myob2 = {}
    myob2['email'] = this.state.beforeIM.email
    axios.post('http://localhost:5000/api/process/reverse_video', myob2)
 	 .then(res => {
     var myAr = []
     myAr.push(res.data)
     this.setState({afterIM: myAr}, () => {
  ...
  console.log(error);
    ...
    var myob2 = {}
    myob2['email'] = this.state.beforeIM.email
    axios.post('http://localhost:5000/api/process/sharpen', myob2)
 	 .then(res => {
     console.log(res.data)
     var myAr = []
     myAr.push(res.data)
